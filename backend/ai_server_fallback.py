...
FALLBACK_DIAGNOSES = {
    ...
    ('fever', 'cough', 'fatigue'): {
        ...
        'recommendations': {
            ...
            'lifestyle': ['Stay hydrated', 'Get plenty of rest', 'Isolate if contagious'],
            'when_to_see_doctor': ['If fever over 101.5°F persists', 'Difficulty breathing', 'Symptoms worsen after 7 days']
        }
    },
    ('headache', 'nausea', 'dizziness'): {
        ...
        'recommendations': {
            ...
            'lifestyle': ['Avoid bright lights', 'Stay hydrated', 'Regular sleep schedule'],
            'when_to_see_doctor': ['Severe headache with fever', 'Vision changes', 'Persistent nausea']
        }
    },
    ('sore_throat', 'fever', 'body_aches'): {
        ...
        'confidence': 0.75,
        'recommendations': {
            'medications': ['Throat lozenges', 'Warm salt water gargle', 'Pain relievers'],
            'lifestyle': ['Rest', 'Warm liquids', 'Humidifier'],
            'when_to_see_doctor': ['White patches in throat', 'High fever', 'Difficulty swallowing']
        }
    },
    ('chest_pain', 'shortness_of_breath'): {
        ...
        'recommendations': {
            ...
            'lifestyle': ['Do not delay medical care', 'Call emergency services if severe'],
    ...
    ('diarrhea', 'nausea', 'fatigue'): {
        ...
        'recommendations': {
            ...
            'lifestyle': ['Rest', 'Avoid dairy and fatty foods', 'Gradual diet reintroduction'],
            'when_to_see_doctor': ['Severe dehydration', 'Blood in stool', 'High fever with symptoms']
        }
    }
}
...
def extract_symptoms_from_text(text):
    ...
    symptom_keywords = {
        ...
        'shortness_of_breath': ['shortness of breath', 'breathing difficulty', 'cant breathe', 'hard to breathe'],
    ...
    try:
        ...
        if not best_match:
            ...
            best_match = {
                ...
                'confidence': 0.60,
                'recommendations': {
                    'medications': ['Monitor symptoms', 'Over-the-counter pain relief if needed'],
                    'lifestyle': ['Rest', 'Stay hydrated', 'Monitor for changes'],
                    'when_to_see_doctor': ['If symptoms worsen', 'If symptoms persist beyond 7 days', 'If new symptoms develop']
                }
            }
        ...
        logger.info(f"Fallback diagnosis complete: {best_match['diagnosis']} (confidence: {final_confidence:.3f})")
...
def model_info():
    ...
    return jsonify({
        ...
        'available_features': ['Symptom pattern matching', 'Basic diagnosis suggestions'],
