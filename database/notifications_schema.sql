-- =====================================================
-- NOTIFICATIONS TABLE SCHEMA FOR MEDICHAIN
-- Complete notification system with categories and priorities
-- =====================================================
...
-- Note: No sequence grants needed since we use UUID primary keys
