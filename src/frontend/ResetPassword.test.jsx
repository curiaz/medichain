...
describe('ResetPassword Component - OTP Enhanced', () => {
    ...
    it('successfully sends OTP request', async () => {
      ...
      await waitFor(() => {
        expect(mockedAxios.post).toHaveBeenCalledWith(
          'https://medichainn.onrender.com/api/auth/password-reset-request',
  ...
  describe('Step 2: OTP Verification', () => {
    ...
    it('successfully verifies OTP', async () => {
      ...
      await waitFor(() => {
        expect(mockedAxios.post).toHaveBeenCalledWith(
          'https://medichainn.onrender.com/api/auth/verify-otp',
  ...
  describe('Step 3: New Password', () => {
    ...
    it('successfully resets password', async () => {
      ...
      await waitFor(() => {
        expect(mockedAxios.post).toHaveBeenCalledWith(
          'https://medichainn.onrender.com/api/auth/password-reset',
          {
            email: 'test@example.com',
            reset_token: 'test-token',
