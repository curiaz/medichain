...
const ProfilePage = () => {
  ...
  const loadProfile = async (skipRedirect = false) => {
    try {
      ...
      if (token) {
        try {
          const response = await fetch('https://medichain.clinic/api/profile/patient', {
            headers: {
  ...
  const handleSavePersonalInfo = async () => {
    try {
      ...
      const response = await fetch('https://medichain.clinic/api/profile/patient/update', {
        method: 'PUT',
        headers: {
  ...
  const handleSaveMedicalInfo = async () => {
    try {
      ...
      const response = await fetch('https://medichain.clinic/api/profile/patient/medical', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleDocumentUpload = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://medichain.clinic/api/profile/patient/documents', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const handleSavePrivacySettings = async () => {
    try {
      ...
      const response = await fetch('https://medichain.clinic/api/profile/patient/privacy', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
