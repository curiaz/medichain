...
const DoctorAIDiagnosisReview = () => {
    ...
    useEffect(() => {
      const checkStatus = async () => {
        try {
          ...
          const response = await axios.get(`https://medichainn.onrender.com/api/medical-reports/appointment/${appointment.id}`, {
  ...
  const checkReviewStatus = async (aptId) => {
    try {
      ...
      const response = await axios.get(`https://medichainn.onrender.com/api/medical-reports/appointment/${aptId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const loadMedicalReport = async (apptId) => {
    try {
      ...
      const response = await axios.get(`https://medichainn.onrender.com/api/medical-reports/appointment/${apptId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post('https://medichainn.onrender.com/api/medical-reports', medicalReportData, {
        headers: { 
